  ...
  return (
    <div className="App">
      ...
      <div>
        ...
        <button onClick={() => mint()}>Mint Holiday NFT</button>
      </div>

      <div>
        <button onClick={() => viewNFT()}>View Holiday NFT</button>
      </div>

        { scriptResult.length !== 0
          ? <div>
              <img style={{width: "100px"}} src={`https://ipfs.infura.io/ipfs/${scriptResult[0]}`} alt="xmas" />
